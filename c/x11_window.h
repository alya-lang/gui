#ifndef ALYA_GUI_X11_H
#define ALYA_GUI_X11_H

// X11 fallback backend contract: identical API to c/win32_window.h.
// Compiled only on Linux (c-sources-linux) when native Wayland is absent.
